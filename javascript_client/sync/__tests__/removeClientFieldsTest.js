...
describe("removing @client fields", () => {
    ...
    it("returns a string without any fields with @client", () => {
        var newString = (0, removeClientFields_1.removeClientFieldsFromString)("{ f1 f2 @client { a b } f3 { a b @client } }");
    ...
    it("leaves other strings unchanged", () => {
        ...
        var newString = (0, removeClientFields_1.removeClientFieldsFromString)(originalString);
    ...
    it("removes now-unused variables", () => {
        var newString = (0, removeClientFields_1.removeClientFieldsFromString)("query($thing: ID!){ f1 f2(thing: $thing) @client }");
